...
// Función para obtener los datos de los terremotos
...
// Función para actualizar la tabla de terremotos
...
// Funciones para mostrar y cerrar el modal de actualización de perfil
...
// Funciones para mostrar y cerrar el modal de carga de foto de perfil
...
// Evento para enviar el formulario de actualización de usuario
document
...
// Evento para enviar el formulario de carga de foto de perfil
document
  .getElementById("profile-pic-form")
  .addEventListener("submit", function (e) {
    e.preventDefault();
...
// Evento para enviar una petición al servidor antes de cerrar la página
