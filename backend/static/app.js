...
// Función para mostrar el mensaje de confirmación de eliminación de un comentario
...
// Función para mostrar el campo de respuesta a un comentario
...
const createCommentNode = (commentObject) => {
  ...
  if (
    commentObject.user.username == data.currentUser.username ||
    data.currentUser.username === "Admin"
  ) {
...
// Función para inicializar los comentarios en el DOM
